  ...
  const pubpubRecords = [
    ...
    },
    {
      ...
      data: {
        ...
        description: 'An open-access journal exploring how groups of individuals can collectively solve problems.',
    ...
    },
    {
      recordId: 'author-002',
      type: 'Author',
      data: { name: 'Maha Bali', orcid: '0000-0003-9876-5432', affiliation: 'American University in Cairo', },
    },
    {
      recordId: 'author-003',
      type: 'Author',
      data: { name: 'Stefan Müller', orcid: '0000-0001-5555-4444', affiliation: 'University of Vienna', },
    },
    {
      recordId: 'author-004',
      type: 'Author',
  ...
  const grantsRecords = [
    ...
    },
    {
      ...
      data: {
        ...
        endDate: '2026-05-31',
        abstract: 'Developing ML techniques for automated construction and maintenance of scientific knowledge graphs.',
    ...
    },
    {
      ...
      data: {
        ...
        endDate: '2025-08-31',
        abstract: 'Studying how metrics and incentive structures affect the adoption of open science practices.',
    ...
    },
    {
      ...
      data: {
        ...
        endDate: '2026-12-31',
        abstract: 'Implementing decentralized identifier systems for research outputs and datasets.',
    ...
    },
    {
      ...
      data: {
        ...
        endDate: '2026-02-28',
        abstract: 'Developing open-source tools for community-owned scholarly publishing and archiving.',
  ...
  const climateRecords = [
    {
      ...
      type: 'Station',
      data: { name: 'Mauna Loa Observatory', country: 'US', latitude: 19.536, longitude: -155.576, elevation: 3397, },
    },
    {
      recordId: 'station-002',
      type: 'Station',
      data: { name: 'Cape Grim', country: 'AU', latitude: -40.683, longitude: 144.689, elevation: 94, },
    },
    {
      recordId: 'station-003',
      type: 'Station',
      data: { name: 'Ny-Ålesund', country: 'NO', latitude: 78.923, longitude: 11.923, elevation: 11, },
    },
    {
      recordId: 'station-004',
      type: 'Station',
      data: { name: 'Izaña Observatory', country: 'ES', latitude: 28.309, longitude: -16.499, elevation: 2373, },
    },
    {
      recordId: 'obs-001',
      type: 'Observation',
  ...
  const pubnotesRecords = [
    ...
    },
    {
      ...
      data: {
        ...
        body:
          'The Journal of Trial and Error piece makes a compelling case that failure is not noise to be filtered out but signal to be amplified. Key insight: null results constrain the hypothesis space just as strongly as positive results.',
    ...
    },
    {
      ...
      data: {
        ...
        body:
          "Maha Bali's work on equity in open education keeps returning to a core tension: openness can democratize access while simultaneously exposing vulnerable learners to extractive platforms. Worth revisiting with the new data governance lens.",
    ...
    },
    {
      ...
      data: {
        ...
        body:
          "D'Ignazio's framing of data as always already political maps well onto our underlay design questions. Who decides what counts as a record type? What gets schematized vs. left as freetext? These are power questions.",
    ...
    },
    {
      ...
      data: {
        ...
        body:
          "The collective memory piece draws on Halbwachs in ways I hadn't expected. The argument that online communities form memory through repetition rather than storage resonates with how underlay versions work — it's the diff, not the snapshot, that carries meaning.",
