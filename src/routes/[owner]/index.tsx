              ...
              <div className="relative group">
                ...
                <div className="hidden group-hover:block absolute left-0 top-full mt-1 bg-parchment border border-rule shadow-sm z-10 min-w-[16rem]">
                  <div className="p-3 border-b border-rule">
                    ...
                    <code className="block text-[11px] text-ink-muted break-all bg-parchment-dark px-2 py-1">{`at://did:web:underlay.org:${owner}`}</code>
                    <p className="text-[10px] text-ink-muted mt-1">Follow in any AT Proto app</p>
                  </div>
                  <div className="p-3">
                    <p className="text-xs font-medium mb-1">API</p>
                    <code className="block text-[11px] text-ink-muted break-all bg-parchment-dark px-2 py-1">{`GET /api/accounts/${owner}/collections`}</code>
