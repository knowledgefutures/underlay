          ...
          <section className='py-12 border-b border-rule'>
            <div className='max-w-2xl'>
              ...
              <p className='text-ink-muted text-sm leading-relaxed mb-2'>
                This is a mirror of{' '}
                <Link to={mirrorConfig.upstream} className='underline hover:text-ink'>
                  {mirrorConfig.upstream.replace(/^https?:\/\//, '',)}
                </Link>. It maintains a verified copy of all public collections for long-term preservation and local
                access.
              </p>
              <p className='text-ink-muted text-sm leading-relaxed mb-6'>
                Every version, record, and file is content-addressed and hash-verified against the upstream source. If
                the primary server becomes unavailable, this mirror serves as an independent, complete archive.
              </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 text-sm'>
              <div>
                ...
                <p className='text-ink-muted'>
                  This server replicates public collections from the canonical Underlay instance. Each copy is
              ...
              <div>
                ...
                <p className='text-ink-muted'>
                  Running on separate hardware with its own database and storage. No single point of failure — if the
                  upstream goes down, the data persists here.
                </p>
              </div>
              <div>
                <h3 className='font-semibold mb-1 font-sans'>Open and browsable</h3>
                <p className='text-ink-muted'>
                  Browse any collection, inspect any schema, view any record. The same API works here as on the primary
                  server.
                </p>
              </div>
            </div>
          ...
          <section className='py-8'>
            <div className='flex gap-8 text-sm'>
              <div>
                ...
                <p className='text-ink-muted'>
                  Underlay is open-source infrastructure for structured knowledge preservation. Anyone can run a mirror
                  — same software, different server.
                </p>
              </div>
              <div>
      ...
      <div className='max-w-5xl mx-auto px-4'>
        ...
        <section className='py-12 border-b border-rule'>
          <div className='max-w-2xl'>
            ...
            <p className='text-ink-muted text-sm leading-relaxed mb-6'>
              Apps publish versioned snapshots of their data to Underlay. Each version is self-describing: a JSON
              Schema, flat records, content-addressed files. The structure is the infrastructure.
            </p>
            <div className='flex gap-3'>
              <Link
                to='/docs'
        ...
        <section className='py-8 border-b border-rule'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 text-sm'>
            <div>
              ...
              <p className='text-ink-muted'>
                Your app serializes its current state and pushes a versioned snapshot to Underlay over HTTPS. A cron
                job, a webhook, or a button.
              </p>
            </div>
            <div>
              <h3 className='font-semibold mb-1 font-sans'>2. Store</h3>
              <p className='text-ink-muted'>
                Underlay validates records against the JSON Schema, deduplicates files by hash, and stores the version
                immutably.
              </p>
            </div>
            <div>
