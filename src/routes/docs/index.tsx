...
export default function Docs() {
  return (
    <DocsLayout title='Documentation'>
      <p>
        Underlay has a small API surface. These docs are the SDK. Read them, point your LLM at them, or just curl the
        endpoints. For a machine-readable version, see{' '}
        <Link to='/.well-known/ai.txt' className='text-link underline'>ai.txt</Link>.
      </p>
      ...
      <nav className='space-y-5 text-sm'>
        <section>
          ...
          <ul className='space-y-1 pl-0.5'>
            <li>
              <Link to='/docs/concepts' className='text-link underline'>Concepts</Link>{' '}
              <span className='text-ink-muted text-xs'>— Collections, versions, records, files</span>
            </li>
            <li>
              <Link to='/docs/quickstart' className='text-link underline'>Quickstart</Link>{' '}
              <span className='text-ink-muted text-xs'>— Push your first version in 5 minutes</span>
            </li>
            <li>
              <Link to='/docs/integration' className='text-link underline'>Integration Guide</Link>{' '}
        ...
        <section>
          ...
          <ul className='space-y-1 pl-0.5'>
            <li>
              <Link to='/docs/api' className='text-link underline'>Overview</Link>{' '}
            ...
            <li>
              ...
              <span className='text-ink-muted text-xs'>— Upload and download content-addressed files</span>
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className='space-y-1 pl-0.5'>
            <li>
              <Link to='/docs/self-host' className='text-link underline'>Self-hosting</Link>{' '}
